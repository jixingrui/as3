package azura.banshee.zebra.branch
{
	...
	public class Zbitmap2 implements Zebra2BranchI, Zframe2I,ZbitmapI
	{
...
//		}
		...
		public function startUse(user:Zframe2ListenerI):void
		{
//			this.loader=loader;
//			loader.loadBitmap(this);
//			user.notifyLoadedByZframe2();
		}
