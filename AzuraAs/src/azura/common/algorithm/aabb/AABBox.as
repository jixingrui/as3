...
package azura.common.algorithm.aabb
{
	...
	{	
		 ...
		 */
		public function AABBox(x:Number = 0, y:Number = 0, width:Number = 0, height:Number = 0):void
		{
			minX = x;
			minY = y;
			maxX = x + width;
		...
		public function inflate(deltaX:Number, deltaY:Number):AABBox
		{
			minX -= deltaX;
			minY -= deltaY;
			maxX += deltaX;
		...
		public function union(aabb:AABBox):AABBox
		{
		...
		public function asUnionOf(aabb1:AABBox, aabb2:AABBox):AABBox
		{
		...
		public function getIntersection(aabb:AABBox):AABBox 
		{
			var intersection:AABBox = this.clone();
		...
		public function clone():AABBox
		{
			return new AABBox(minX, minY, maxX - minX, maxY - minY);
		}

		/** Copies values from the specified `aabb`. */
		public function fromAABB(aabb:AABBox):AABBox
		{
			minX = aabb.minX;
			minY = aabb.minY;
			maxX = aabb.maxX;
