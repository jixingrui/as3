...
{
	import azura.common.algorithm.aabb.InsertChoice;
	 ...
	 * @author azrafe7
	 */
	public class InsertStrategyManhattan implements IInsertStrategy
	{
		protected var combinedAABB:AABBox = new AABBox();
		
		public function choose(leafAABB:AABBox, parent:Node, extraData:* = null):InsertChoice
		{
