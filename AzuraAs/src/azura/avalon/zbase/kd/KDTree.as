...
package azura.avalon.zbase.kd
{
	...
	import azura.avalon.zbase.kd.StandardLib;
	import azura.avalon.zbase.kd.VectorUtils;
	...
	public class KDTree
	{
		 ...
		 */
		public function KDTree(dimensionality:uint=2)
		{
		 ...
		 */
		public function insert(obj:Object, ... key):KDNode
		{
