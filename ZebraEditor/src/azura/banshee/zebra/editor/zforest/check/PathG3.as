package azura.banshee.zebra.editor.zforest.check
{
	...
	public class PathG3 implements GsingleI
	{
		private var start_end:Boolean=true;
		private var host:LayerZforestCheck3;
		public function PathG3(host:LayerZforestCheck3)
		{
			this.host=host;
		}
		...
		{
			var xg:int=host.ec.space.xView+x;
			var yg:int=host.ec.space.yView+y;
			...
			if(start_end){
				...
				host.mouseMode=LayerZforestCheck3.mouse_move;
			}else{
