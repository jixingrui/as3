package azura.banshee.zebra.editor.zforest
{
	...
	public class Zforest3 implements GsI
	{
		/**
		 *in percentage 
		 */
		public var scale:int=100;
		public var land:Zebra3=new Zebra3();
		public var mask:Zmask=new Zmask();
		public var base:Zbase=new Zbase();
		public var way:Zway;
		public var ztreeList:Vector.<Ztree3>=new Vector.<Ztree3>();
		...
		public function toBytes():ZintBuffer
		{
			...
			for each(var zt:Ztree3 in ztreeList){
