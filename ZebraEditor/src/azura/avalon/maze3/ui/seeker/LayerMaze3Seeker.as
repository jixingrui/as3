package azura.avalon.maze3.ui.seeker
{
	...
	public class LayerMaze3Seeker implements Stage3DLayerI
	{
		public static var instance:LayerMaze3Seeker;
		...
		private var this_:LayerMaze3Seeker;
		...
		public var panel:Maze3SeekerEdit;
		
		public function LayerMaze3Seeker(gl:G2dLayer,stage:Stage)
		{
			this.gl=gl;
			this.stage=stage;
			this_=this;
...
//				dn.observer=new WooObserver(d,dn,this);
			}
		}
