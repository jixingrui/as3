package azura.avalon.maze3.service
{
	...
	public class Maze3DoorEditNet extends FrackSocketA implements RpcTunnelI
	{
		public static var nsMaze3:NameSpace=new NameSpace(Def_maze3.data);
		public static var cs:SwitchDoorCs;
		
		public function Maze3DoorEditNet(config:FrackConfigI) {
			super(config);
			var local:SwitchDoorCs=new SwitchDoorCs(this);
